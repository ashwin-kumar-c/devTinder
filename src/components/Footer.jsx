const Footer = () => {
  return (
    // <footer className="footer bg-neutral text-neutral-content items-center px-4 py-2 fixed bottom-0 min-h-[48px]">
    ...
    //     {["twitter", "youtube", "facebook"].map((_, i) => (
    //       <svg
    //         key={i}
    //         xmlns="http://www.w3.org/2000/svg"
    //         width="20"
    //         height="20"
    //         viewBox="0 0 24 24"
    //         className="fill-current opacity-80 hover:opacity-100 cursor-pointer"
    //       >
    //         {/* icon path unchanged */}
    //       </svg>
    //     ))}
